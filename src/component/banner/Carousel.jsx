...
const Carousel = () => {
  ...
  return (
    <div id="default-carousel" className="relative w-full h-full xs:ml-10" data-carousel="slide">
      ...
      <div className="relative xs:h-56 h-[50rem] mt-20 overflow-hidden rounded-lg md:h-96">
        {/* Render slides here */}
      ...
      {/* Slider controls */}
      <button type="button" className="absolute mt-[-2rem] xs:mt-10  top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={prevSlide}>
      ...
      <button type="button" className="absolute mt-[-2rem] mr-[-2rem] xs:mt-10 top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={nextSlide}>
        <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
          <svg className="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
